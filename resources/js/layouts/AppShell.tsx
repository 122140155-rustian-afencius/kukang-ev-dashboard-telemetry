...
export default function AppShell({ children }: Props) {
    ...
    return (
        <div className="flex min-h-screen w-full flex-1 flex-col rounded-md border border-neutral-200 bg-gray-100 md:flex-row dark:border-neutral-700 dark:bg-neutral-800">
...
export const Logo = () => {
    return (
        <a href="#" className="relative z-20 flex items-center space-x-2 py-1 text-sm font-normal text-black">
            <img src="/logo-kukang.png" alt="Kukang Logo" className="h-5 w-6 shrink-0 rounded-sm" />
